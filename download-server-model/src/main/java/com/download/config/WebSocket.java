...
public class WebSocket {
    ...
    public void onOpen(@PathParam("cid") String cid, Session session) {
        log.info("连接建立中 ==> session_id = {}， sid = {}", session.getId(), cid);
        ...
        log.info("连接建立成功，当前在线数为：{} ==> 开始监听新连接：session_id = {}， sid = {},。", onlineSessionClientCount, session.getId(), cid);
    }
    ...
    public void onClose(@PathParam("cid") String cid, Session session) {
        ...
        log.info("连接关闭成功，当前在线数为：{} ==> 关闭该连接信息：session_id = {}， sid = {},。", onlineSessionClientCount, session.getId(), cid);
    }
    ...
    public void onMessage(String message, Session session) {
        ...
        log.info("服务端收到客户端消息 ==> fromSid = {}, toSid = {}, message = {}", cid, toSid, message);
    ...
    private void sendToAll(String message) {
        ...
        onlineSessionClientMap.forEach((onlineCid, toSession) -> {
            ...
            if (!cid.equalsIgnoreCase(onlineCid)) {
                log.info("服务端给客户端群发消息 ==> sid = {}, toSid = {}, message = {}", cid, onlineCid, message);
